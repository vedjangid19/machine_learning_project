...
from housing.entity.artifact_entity import DataIngestionArtifact,\
    DataTransformationArtifact,DataValidationArtifact, ModelEvaluationArtifact, ModelTrainerArtifact,ModelPusherArtifact
from housing.entity.config_entity import DataIngestionConfig
from housing.component.data_validation import DataVlidation
    ...
    def start_model_evaluation(
        ...
        try:
            model_eval = ModelEvaluation(
                modle_evaluation_config=self.config.get_model_evaluation_config(),
                data_ingestion_artifact=data_ingestion_artifact,
                data_validation_artifact=data_validation_artifact,
    ...
    def run_pipeline(self):
        try:
            if Pipeline.experiment.running_status:
                logging.info(f"Pipeline already running.")
            ...
            if model_evaluation_artifact.is_model_accepted:
                model_pusher_artifat = self.start_model_pusher(
                    model_eval_artifact=model_evaluation_artifact
                )
                logging.info(f"Model Pusher Artifact {model_pusher_artifat}")
            else:
    ...
    def save_experiment(self):
        try:
            if Pipeline.experiment.experiment_id is not None:
                ...
                logging.info(f"First StartExperiment.")
