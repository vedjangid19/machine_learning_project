...
class Configuration:
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            model_triner_artifact_dir = os.path.join(
                artifact_dir,
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        try:
            ...
            logging.info(f"Model Evalution Config: {model_evaluation_config}")
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        try:
            ...
            model_pusher_confif_info = self.config_info[MODEL_PUSHER_CONFIG_KEY]
            
            export_dir_path = os.path.join(
                ROOT_DIR,
                model_pusher_confif_info[MODEL_PUSHER_MODEL_EXPORT_DIR_KEY],
                time_stamp
            )
