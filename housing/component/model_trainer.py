...
class HousingEstimatorModel:
    ...
    def predict(self,X):
        """
        function accepts raw inputs and than transformed raw input using
        preprocessing_object which gurantees that the inputs are in the same
        format as the training data at last it perform prediction on tranformed 
        features.
        """
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            logging.info(f"Best Found Model On Both Training And Teating Dataset.")
