...
from housing.constant import BEST_MODEL_KEY, HISTORY_KEY, MODEL_PATH_KEY, TARGET_COLUMN_KEY
...
class ModelEvaluation:
    ...
    def __init__(self,modle_evaluation_config:ModelEvaluationConfig,
                 data_ingestion_artifact:DataIngestionArtifact,
                 data_validation_artifact:DataValidationArtifact,
                 model_trainer_artifact:ModelTrainerArtifact):
        try:
            logging.info(f"{'<<'*30}Model Evaluation log started.{'>>'*30}")
            self.modle_evaluation_config = modle_evaluation_config
    ...
    def get_best_model(self):
        try:
            ...
            model_evaluation_file_path = self.modle_evaluation_config.model_evaluation_file_path
    ...
    def update_evaluation_report(self,
        ...
        try:
            eval_file_path = self.modle_evaluation_config.model_evaluation_file_path
            ...
            if previous_best_model is not None:
                model_history = {self.modle_evaluation_config.time_stamp: previous_best_model}
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            # Dropping Target Column From The Database
            logging.info(f"Dropping Target COlumn From Database.")
